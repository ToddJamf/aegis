...
*Mentor 2026.06.13 — Person / 1:1 prep skill. Carved from Oracle (account vs. person boundary). Capabilities: 1:1 prep (direction DOWN to a report, direction UP to your manager). Built on the Aegis shared layer (identity · source-routing · error-handling · output-discipline · redirect). disable-model-invocation removed 2026-06-13 — UAT active.*
